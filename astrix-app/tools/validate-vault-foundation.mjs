...
assert.match(vaultRuntime,/import \{bindParadoxItemHover,bindParadoxItemInspect\} from '\.\.\/guardian-workspace-v2\/paradox-item-hover\.mjs/,'Vault must keep its existing page hover controller and add the shared click inspector.');

...
assert.match(sharedTileCss,/height:\s*var\(--apx-icon-gear-art-height\);\s*aspect-ratio:\s*var\(--apx-inventory-ratio,100\/122\)/,'The shared tile accepts the DIM square opt-in and preserves the legacy 100:122 fallback');

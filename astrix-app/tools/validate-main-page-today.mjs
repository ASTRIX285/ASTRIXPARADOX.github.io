...
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260914-resilient-transfer-2/,'Main must load the resilient transfer dependency graph without a stale module cache');

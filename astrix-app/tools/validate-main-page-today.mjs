...
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260913-drag-drop-2/,'Main must load the drag-and-drop dependency graph without a stale module cache');

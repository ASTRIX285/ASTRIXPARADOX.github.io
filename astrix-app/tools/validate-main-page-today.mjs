...
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260913-orbit-transfer-1/,'Main must load the orbit-safe transfer dependency graph without a stale module cache');

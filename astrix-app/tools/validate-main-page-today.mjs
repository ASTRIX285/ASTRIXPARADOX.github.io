...
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260914-fast-transfer-1/,'Main must load the fast resilient transfer dependency graph without a stale module cache');

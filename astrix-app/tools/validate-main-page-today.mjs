...
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260914-resilient-transfer-1/,'Main must load the resilient transfer dependency graph without a stale module cache');

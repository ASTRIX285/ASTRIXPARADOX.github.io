...
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260913-direct-transfer-1/,'Main must load the direct-transfer dependency graph without a stale module cache');

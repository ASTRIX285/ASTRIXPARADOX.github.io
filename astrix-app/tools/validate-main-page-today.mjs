...
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260913-character-safe-2/,'Main must load the partial-data-safe dependency graph without a stale module cache');

...
assert.match(workspaceHtml,/guardian-workspace-v2\.mjs\?v=20260913-live-transfer-1/,'Main must load the live-transfer dependency graph without a stale module cache');

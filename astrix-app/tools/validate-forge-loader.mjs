...
assert.match(html,/forge-loader\.css\?v=20260911-inline-set-list-1/,'Forge Loader must load the inline reduced-icon Set Bonus layout without stale page CSS.');
...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260913-live-character-2/,'Build Forge must load the repaired live-equipped protected build transfer without stale browser code.');

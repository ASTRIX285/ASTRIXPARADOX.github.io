...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260913-character-safe-1/,'Build Forge must load the partial-data-safe protected build transfer without stale browser code.');

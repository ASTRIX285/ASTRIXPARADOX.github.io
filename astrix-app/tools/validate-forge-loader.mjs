...
assert.match(html,/forge-loader\.mjs\?v=20260913-backend-solver-1/,'Forge Loader must load the backend solver runtime without stale browser code.');
...
assert.match(read('astrix-app/pages/guardian-workspace-v2/paradox-build-space/index.html'),/paradox-build-space\.mjs\?v=20260913-live-character-3/,'Build Forge must load the repaired live-equipped protected build transfer without stale browser code.');

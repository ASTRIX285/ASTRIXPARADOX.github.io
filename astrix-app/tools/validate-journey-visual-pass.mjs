...
assert.ok(html.includes('src="../../shared/astrix-hero-cards.mjs?v=20260913-live-character-2&amp;transport=20260911-compact-plugs-1"'),'Journey must load the repaired shared prepared-profile hero-card renderer');

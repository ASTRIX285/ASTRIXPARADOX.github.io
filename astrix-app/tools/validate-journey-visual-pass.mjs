...
assert.ok(characterHtml.includes('guardian-workspace-v2.mjs?v=20260913-character-safe-1'),'Character must load the partial-data-safe live module graph');
assert.ok(buildForgeHtml.includes('paradox-build-space.mjs?v=20260913-character-safe-1'),'Build Forge must load the partial-data-safe live module graph');

...
import {initJourneyLocationMaps,publishJourneyDestinationData,publishJourneyRegionChestProgress} from './journey-location-maps.mjs?v=20260920-zoom-chests-3&markers=20260925-24&chestnote=20260925-25&sources=20260925-1';
...
try{
  ...
  if(authenticated){
    ...
    void preloadPreparedWorkspace(session).catch(error=>console.info('[Forge Journey] prepared workspace preload unavailable',error));

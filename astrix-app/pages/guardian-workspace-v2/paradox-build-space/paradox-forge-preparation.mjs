...
export class ForgePreparationClient{
  constructor({workerFactory=()=>new Worker(new URL('./paradox-forge-worker.mjs?v=20260916-weapon-combinations-2&entry=20260921-direct-1&plain=20260925-1',import.meta.url),{type:'module',name:'paradox-forge'}),onStatus=()=>{},maxEntries=4,maxBytes=8*1024*1024,timeoutMs=120000}={}){

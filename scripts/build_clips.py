...
<head>
  ...
  <style>
    ...
    .filter-label{font-family:'bahnschrift-semicondensed',monospace;font-size:11px;letter-spacing:4px;color:var(--grey);text-transform:uppercase;min-width:60px;padding-right:16px;border-right:1px solid rgba(139,0,0,0.2);margin-right:4px;flex-shrink:0}
    .filter-pills{display:flex;flex-wrap:wrap;gap:2px;padding:8px 0 8px 8px}
    .filter-btn{font-family:'bahnschrift-semicondensed',monospace;font-size:11px;letter-spacing:2px;padding:7px 18px;border:1px solid transparent;color:var(--grey);cursor:pointer;text-transform:uppercase;transition:all 0.2s;background:transparent;white-space:nowrap}
    ...
    .game-section-label{font-family:'bahnschrift-semicondensed',monospace;font-size:11px;letter-spacing:5px;color:var(--gold);text-transform:uppercase;white-space:nowrap;flex-shrink:0}
    ...
    .clip-game-badge{position:absolute;top:10px;left:10px;font-family:"bahnschrift-semicondensed",monospace;font-size:11px;letter-spacing:2px;color:var(--white);background:var(--crimson);padding:3px 10px;text-transform:uppercase}
    .clip-type-badge{position:absolute;top:10px;right:10px;font-family:"bahnschrift-semicondensed",monospace;font-size:11px;letter-spacing:2px;color:var(--dark);background:var(--gold);padding:3px 10px;text-transform:uppercase}
    .clip-duration{position:absolute;bottom:10px;right:10px;font-family:"bahnschrift-semicondensed",monospace;font-size:11px;color:var(--white);background:rgba(0,0,0,0.8);padding:2px 8px;letter-spacing:1px}
    ...
    .clip-link{font-family:"bahnschrift-semicondensed",monospace;font-size:11px;letter-spacing:2px;color:var(--gold);text-transform:uppercase;text-decoration:none;transition:color 0.2s}
    ...
    .clip-modal-close{position:absolute;top:-44px;right:0;font-family:"bahnschrift-semicondensed",monospace;font-size:11px;letter-spacing:2px;color:var(--grey);background:none;border:none;cursor:pointer;text-transform:uppercase}
    ...
    .clip-modal-label{font-family:"bahnschrift-semicondensed",monospace;font-size:11px;letter-spacing:2px;color:var(--grey);text-align:center;margin-top:16px;text-transform:uppercase}
    .clip-modal-source{font-family:"bahnschrift-semicondensed",monospace;font-size:11px;letter-spacing:2px;color:var(--gold);text-align:center;margin-top:6px}
    .clips-stats{display:flex;gap:24px;align-items:center;padding:12px 0;font-family:"bahnschrift-semicondensed",monospace;font-size:11px;letter-spacing:2px;color:var(--grey);border-bottom:1px solid rgba(139,0,0,0.1);margin-bottom:24px;flex-wrap:wrap}
    .clips-stats span{color:var(--white)}
    @media(max-width:768px){.clips-hero{padding:calc(var(--nav-height) + 40px) 20px 40px}.clips-grid{grid-template-columns:1fr}.filter-wrap{padding:0 20px}.filter-label{min-width:48px;font-size:7px;letter-spacing:2px}.filter-btn{font-size:11px;padding:6px 12px}}
  </style>
...
<div class="clips-hero">
  <div style="max-width:1100px;margin:0 auto;position:relative;z-index:1;">
    ...
    <div style="display:flex;gap:16px;margin-top:24px;animation:fadeUp 0.8s ease 0.8s both;flex-wrap:wrap;">
      <a href="https://www.youtube.com/@ASTRIXPARADOX" target="_blank" class="btn-primary" style="font-size:11px;padding:10px 24px;">&#9654; &nbsp; YouTube Channel &#8599;</a>
    </div>
  </div>
</div>
...
<section class="section" style="background:var(--dark);padding-top:32px;">
  <div style="max-width:1100px;margin:0 auto;">
    <div class="clips-stats">
      ...
      &nbsp;&middot;&nbsp; <a href="https://www.youtube.com/@ASTRIXPARADOX" target="_blank" style="color:var(--gold);font-family:'bahnschrift-semicondensed',monospace;font-size:11px;letter-spacing:2px;">SUBSCRIBE ON YOUTUBE &#8599;</a>
    </div>
    <div id="clipsGrid">
__CARDS_HTML__
    </div>
